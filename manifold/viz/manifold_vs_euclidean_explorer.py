...
All the numeric machinery is reused from ``manifold/analysis/graph_analysis_playroom.py``
...
sys.path.insert(0, str(REPO)); sys.path.insert(0, str(REPO / "manifold" / "analysis"))
