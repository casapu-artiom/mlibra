...
Run:
    python maldi/graph_explorer_napari.py
    python maldi/graph_explorer_napari.py --self-test    # headless logic check
"""
...
# --- repo imports (script lives in maldi/; root holds manifold_gp) -----------
