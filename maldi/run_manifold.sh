...
EXP_NAME="$EXP_PREFIX-MANIFOLD-RSAMPLE-$LATENT_DIM-$STRIDE-$TEMPLATE_NAME-$THRESHOLD-$NUM_INDUCING_POINTS-$BATCH_SIZE-$KNN_METHOD-$NU-$BUMP_SCALE-$BUMP_DECAY-$GRAPHBANDWIDTH"
