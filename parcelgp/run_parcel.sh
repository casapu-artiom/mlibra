...
#   MODE=parcel   ./parcelgp/run_parcel.sh
#   MODE=baseline ./parcelgp/run_parcel.sh
#   LIMIT=4 EPOCHS=1 ./parcelgp/run_parcel.sh      # quick smoke test
#
...
# ---- parcellation (see parcelgp/README.md for what these do) ----
...
# maldi/run_lgp_per_lipid.sh, which defaults to the 5-lipid smoke subset — runs
